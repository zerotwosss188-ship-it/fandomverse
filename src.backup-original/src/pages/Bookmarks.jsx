    ...
    let html = `
      ...
      <head>
        ...
        <style>
          ...
          h1 { color: #dc2626; font-size: 22px; margin-bottom: 4px; }
          h2 { color: #dc2626; font-size: 15px; margin-top: 32px; margin-bottom: 10px; border-bottom: 2px solid #dc2626; padding-bottom: 6px; }
          ...
          .type-trailer { color: #dc2626; font-weight: 600; }
      ...
      Object.entries(byCategory).forEach(([cat, items]) => {
        html += `
          <table>
            <thead>
              <tr>
                <th colspan="2" style="background:#991b1b; font-size: 13px;">${escapeHtml(cat.toUpperCase())} · ${items.length} item${items.length !== 1 ? 's' : ''}</th>
              </tr>
              <tr>
                <th width="40">#</th>
                <th>Title</th>
        ...
        >
          <AnimatePresence>
            {filteredBookmarks.map((b) => {
              const color = catColors[b.category] || '#dc2626';
