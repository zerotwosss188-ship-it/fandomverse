      ...
      >
        ...
        <span
          style={{
            ...
            border: `1px solid ${
              isInterview ? 'rgba(244, 114, 182, 0.5)' : 'rgba(168, 85, 247, 0.5)'
            }`,
            color: isInterview ? '#f472b6' : '#a855f7',
        ...
        <button
          ...
          style={{
            ...
            boxShadow: 'none',
            fontSize: 16, transition: 'transform 0.2s, box-shadow 0.25s', zIndex: 3,
          }}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'scale(1.08)';
            e.currentTarget.style.boxShadow =
              '0 6px 20px rgba(225, 29, 72, 0.6)';
          }}
          onMouseLeave={(e) => {
