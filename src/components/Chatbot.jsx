...
export default function Chatbot() {
  ...
  return (
    <>
      <button
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.boxShadow =
            '0 8px 32px rgba(225, 29, 72, 0.5), 0 0 40px rgba(168, 85, 247, 0.35)';
          e.currentTarget.style.borderColor = 'rgba(225, 29, 72, 0.7)';
        }}
        onMouseLeave={(e) => {
      ...
      >
        {open ? (
          <span style={{ fontSize: 24, color: '#fda4af' }}>×</span>
        ) : (
      ...
      {open && (
        <div
          ...
          style={{
            ...
            boxShadow:
              '0 20px 60px rgba(0,0,0,0.6), 0 0 40px rgba(225,29,72,0.15)',
          }}
        >
          <div
            style={{
...
>
  <span
    style={{
      ...
      height: 6,
      borderRadius: '50%',
      background: aiState === 'idle' ? '#22c55e' : '#fbbf24',
      boxShadow:
        aiState === 'idle'
  ...
  {aiState === 'idle' ? 'online' : aiState}
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.boxShadow =
                  '0 4px 16px rgba(225, 29, 72, 0.55)')
              }
