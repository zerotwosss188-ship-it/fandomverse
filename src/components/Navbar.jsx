...
const exploreItems = [
  ...
  },
  {
    ...
    color: '#60a5fa',
    Icon: FaGamepad,
    banner: '/images/banners/gta-vi.jpg',
  },
  {
    name: 'Movies',
  ...
  },
  {
    name: 'Trailers',
    path: '/trailers',
    desc: 'Every trailer, one place',
    color: '#fb7185',
    Icon: FaVideo,
    banner: '/images/banners/avengers.jpg',
  },
  {
    name: 'Upcoming',
    path: '/releases',
    desc: 'New releases calendar',
    color: '#fbbf24',
    Icon: FaCalendarAlt,
    banner: '/images/banners/dune.jpg',
  },
          ...
          >
            ...
            <Link
              ...
              style={{
                ...
                fontFamily: 'Space Grotesk, sans-serif',
                fontWeight: 600,
                color: location.pathname === '/' ? '#fda4af' : '#8a8a8a',
                textDecoration: 'none',
                whiteSpace: 'nowrap',
            ...
            >
              <button
                ...
                style={{
                  ...
                  fontFamily: 'Space Grotesk, sans-serif',
                  fontWeight: 600,
                  color: isExploreActive ? '#fda4af' : '#8a8a8a',
                        ...
                        >
                          ...
                          <span
                            style={{
                              ...
                              display: 'grid',
                              placeItems: 'center',
                              color: isActive || isHovered ? '#fda4af' : '#8a8a8a',
                              fontSize: 18,
                              flexShrink: 0,
                    ...
                    {exploreQuery.trim() && exploreSuggestions.length > 0 && (
                      ...
                      >
                        {exploreSuggestions.map((s, i) => {
                          ...
                          const color = typeColors[s.type] || '#e11d48';
                          return (
                            <button
                              key={`${s.type}-${s.id}`}
                              type="button"
            ...
            <Link
              ...
              style={{
                ...
                fontWeight: 600,
                color:
                  location.pathname === '/about' ? '#fda4af' : '#8a8a8a',
                textDecoration: 'none',
                whiteSpace: 'nowrap',
                transition: 'color 0.15s ease',
              }}
            ...
            <Link
              ...
              style={{
                ...
                fontWeight: 600,
                color:
                  location.pathname === '/contact' ? '#fda4af' : '#8a8a8a',
                textDecoration: 'none',
                whiteSpace: 'nowrap',
                transition: 'color 0.15s ease',
              }}
            ...
            <Link
              ...
              style={{
                ...
                fontWeight: 600,
                color:
                  location.pathname === '/releases' ? '#fda4af' : '#8a8a8a',
                textDecoration: 'none',
                whiteSpace: 'nowrap',
                transition: 'color 0.15s ease',
              }}
            ...
            <Link
              ...
              style={{
                ...
                fontWeight: 600,
                color:
                  location.pathname === '/trailers' ? '#fda4af' : '#8a8a8a',
                textDecoration: 'none',
                whiteSpace: 'nowrap',
                transition: 'color 0.15s ease',
              }}
