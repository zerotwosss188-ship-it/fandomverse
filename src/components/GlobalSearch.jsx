      ...
      >
        ...
        <input
          ...
          style={{
            ...
            border: `1px solid ${
              open ? 'rgba(168, 85, 247, 0.6)' : 'rgba(255, 255, 255, 0.08)'
            }`,
            borderRadius: 10,
            color: '#f5f5f5',
            fontSize: 13,
      ...
      {showDropdown && (
        <div
          style={{
            ...
            borderRadius: 12,
            boxShadow:
              '0 20px 50px rgba(0,0,0,0.7), 0 0 30px rgba(168, 85, 247, 0.1)',
            zIndex: 200,
            padding: 6,
          }}
        >
