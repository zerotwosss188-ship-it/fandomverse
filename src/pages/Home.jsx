...
const categories = [
  ...
  { name: 'Comics', path: '/category/comics', gradient: 'linear-gradient(135deg, #f87171, #e11d48)', subtitle: 'Marvel · DC · indie', image: '/images/banners/batman.jpg' },
      ...
      {contentData?.content?.length > 0 && (
        <section className="fv-container" style={{ padding: '0 24px 80px' }}>
          ...
          >
            ...
            <TrendingSidebar items={contentData.content} limit={5} />
            </div>
          </div>
        </section>
      )}
